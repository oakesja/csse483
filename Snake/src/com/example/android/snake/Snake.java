...
public class Snake extends Activity {
	...
	private static long SLOW_SPEED = 600;
	private static long MEDIUM_SPEED = 300;
	private static long FAST_SPEED = 100;
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.moveRight:
			...
			break;
		case R.id.slowSpeed:
			mSnakeView.setGameSpeed(SLOW_SPEED);
			resumeGame();
			break;
		case R.id.mediumSpeed:
			mSnakeView.setGameSpeed(MEDIUM_SPEED);
			resumeGame();
			break;
		case R.id.fastSpeed:
			mSnakeView.setGameSpeed(FAST_SPEED);
			resumeGame();
			break;
		case R.id.settingsSubMenu:
			Log.d(SNAKE, "Settings selected");
			break;
		case R.id.resume:
			resumeGame();
			break;
	...
	private void turnLeft() {
		Log.d(SNAKE, "turn left");
		switch (mSnakeView.getDirection()) {
		case SnakeView.NORTH:
			Log.d(SNAKE, "new direction is west");
	...
	class MyGestureListener extends GestureDetector.SimpleOnGestureListener {
		...
		public boolean onDown(MotionEvent event) {
			Log.d(SNAKE, "onDown: " + event.toString());
			return true;
		}
		...
		public boolean onFling(MotionEvent event1, MotionEvent event2,
			...
			Log.d(SNAKE, "onFling: " + event1.toString() + event2.toString() +  " "+ velocityX +" "  + velocityY);
